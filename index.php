...
Description: A WordPress Plugin designed to display a lightbox upon a visitor's first entrance onto your blog. Display a photo, video, text, and an optin form to build your email list.
...
function load_clp_scripts(){
	...
	if($row['enabled'] == 1)
	{
		wp_register_script('clp_colorbox', plugins_url('js/jquery.colorbox-min.js', __FILE__), array('jquery'));
		wp_enqueue_script('clp_colorbox');
